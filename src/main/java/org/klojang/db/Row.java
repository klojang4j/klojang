...
public class Row {
    ...
    /**
     * Returns the value of the specified column as an {@code int}, or {@code nullValue} if the
     * value was {@code null}.
     *
     * @param colName The column name
     * @return An {@code int} representation of the value
    ...
    /**
     * Returns the value of the specified column as a {@code float}, or {@code nullValue} if the
     * value was {@code null}.
     *
     * @param colName The column name
     * @return A {@code float} representation of the value
    ...
    /**
     * Returns the value of the specified column as a {@code long}, or {@code nullValue} if the
     * value was {@code null}.
     *
     * @param colName The column name
     * @return A {@code long} representation of the value
    ...
    /**
     * Returns the value of the specified column as a {@code short}, or {@code nullValue} if the
     * value was {@code null}.
     *
     * @param colName   The column name
     * @param nullValue The value to return if the column values was {@code null}
    ...
    /**
     * Returns the value of the specified column as a {@code byte}, or {@code nullValue} if the
     * value was {@code null}.
     *
     * @param colName   The column name
     * @param nullValue The value to return if the column values was {@code null}

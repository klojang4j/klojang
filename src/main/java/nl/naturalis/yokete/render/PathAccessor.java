...
/**
 * The most versatile {@code Accessor} implementation provided by Yokete. It can retrieve values at
 * any depth from whatever type of object. This is done by converting template variable names into
 * {@link Path} objects, which are then used by a {@link PathWalker} to descend into the object.
